...
useEffect(()=> {
  AOS.init({duration:2000})
       ...
       return (
          ...
          <h1 className="font-bold text-center text-[#212f4f] pt-4 text-2xl" data-aos="fade-left"> Health News</h1>
                    {
                        props.health.map((info,i) => (
                          ...
                          <div  key={i} className="flex items-center justify-center" data-aos="zoom-in">
                            <div  className="flex flex-col items-center justify-center w-[300px] md:w-[400px]  shadow-2xl my-8 ">
                              ...
                              <div className="flex px-8 text-xs py-1 text-[#2a2f4f] font-semibold w-full justify-between">
                              <div>
