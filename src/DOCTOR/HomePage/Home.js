...
function Home(props) {
  ...
  return (
   ...
   <h1 className='text-center font-bold text-white bg-gradient-to-r from-indigo-800 to-cyan-600 '> Plant Pathology (CRP 304)</h1>
 ...
 <h1 className='text-center font-bold text-white bg-gradient-to-r from-indigo-800 to-cyan-600 '> Crop Protection and Disease Control (CRP 405)</h1>
 ...
 {props.loading ?<div></div>:<div className="flex min-h-[400px] justify-center items-center text-xl font-bold"><TailSpin height="80" width="80" radius="9" color="blue" ariaLabel="loading"/></div>}
    ...
    <h1 className='text-center font-bold text-white bg-gradient-to-r from-indigo-800 to-cyan-600 '>Soil Borne and Root Diseases (CRP 511)</h1>
    ...
    {props.loading ?<div></div>:<div className="flex min-h-[400px] justify-center items-center text-xl font-bold"><TailSpin height="80" width="80" radius="9" color="blue" ariaLabel="loading"/></div>}
       ...
       <div className='text-center'>
                ...
                <h3 className='font-mono pb-3 pt-2'>View</h3>
                     ...
                     {/* CRP 512*/}
  <h1 className='text-center font-bold text-white bg-gradient-to-r from-indigo-800 to-cyan-600 '> Plant Disease Control  (CRP512)</h1>
...
<h1 className='text-center font-bold text-white bg-gradient-to-r from-indigo-800 to-cyan-600 '>Pests and Microorganisms in Agriculture  (CRP305)</h1>
...
{props.loading ?<div></div>:<div className="flex min-h-[400px] justify-center items-center text-xl font-bold"><TailSpin height="80" width="80" radius="9" color="blue" ariaLabel="loading"/></div>}
       ...
       <div className='text-center'>
                ...
                <h3 className='font-mono pb-3 pt-2'>View</h3>
                             ...
                             {/* CPT 503*/}
  <h1 className='text-center font-bold bg-gradient-to-r text-white from-indigo-800 to-cyan-600 '>Principles of Nematology (CPT503)</h1>
