...
function Footer() {
  ...
  return (
    ...
    <div className=" text-center font-bold text-gray-900 bg-gradient-to-r from-indigo-800 to-cyan-600  w-full h-[80px] text-base font-sans tracking-wider bg-[#2a2f4f]">
