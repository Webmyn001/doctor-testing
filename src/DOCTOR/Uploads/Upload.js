...
function Upload (props) {
    ...
    useEffect(()=> {
       ...
       return (
          ...
          <h1 className="font-medium text-center text-indigo-800 pt-4 px-2 text-xl" data-aos="fade-left"> Kindly select any of the courses below to upload new lecture.</h1>
                    {
