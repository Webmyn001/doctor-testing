...
function Home() {
  ...
  return (
    ...
    <h1 className='text-center font-semibold font-montserat bg-gradient-to-r text-white from-indigo-800 to-cyan-600 py-[2px]'>Ajadi Muslim Youth Forum</h1>
             ...
             <div className=' text-center text-indigo-800 mt-[20px] '>
    ...
    <div className='flex flex-col shadow-lg w-[350px] sm:w-[400px] h-fit border-2 justify-center border-indigo-800 bg-white   items-center rounded-[32px]'>

               <div className=' text-center text-indigo-800 mt-[15px]'>
                    <h1 className='font-medium text-xs'>Note: You will recieve your Identity Number immediately after the registration.</h1>
                </div>    
                  {/* Formm details */}

  <form className='w-[250px] mt-[30px]' onSubmit={saveForm} encType="multipart/form-data">
    ...
    <input placeholder='Occupation'  value={Occupation} onChange={OnchangeOccupation} required
        className='w-full border-b-[1px] focus:outline-0 text-[14px] pb-[3.5px] mt-[15px] border-indigo-600 text-indigo-700 '/>
   ...
   <input  type="file"  name='Image' onChange={Onchangeimages}
         className='w-full border-b-[1px] focus:outline-0 text-[14px] pb-[3.5px]  border-indigo-600 mb-[15px] mt-[15px]' required/>
